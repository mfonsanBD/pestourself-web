...
export interface QueryRecommended_recommended_section_highlight_float_image {
  __typename: "UploadFile";
  url: string;
}
...
export interface QueryRecommended_recommended_section_highlight {
  ...
  float_image: QueryRecommended_recommended_section_highlight_float_image | null;
  buttonLabel: string;
  buttonLink: string;
